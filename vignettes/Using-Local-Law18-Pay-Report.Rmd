...
Success! From calling the `nyc_locallaw18_payreport` dataset we see there are only 3 rows of data, and from the `distinct()` call we see the only featured "row groups" are those with less than 5 employees. 
