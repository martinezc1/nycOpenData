...
vignette: >
  %\VignetteIndexEntry{NYC Climate Extreme Events}
...
This vignette demonstrates how to use the `nyc_events_sealevel` function to explore projected
extreme climate events and sea level rise for New York City.
...
Researchers, city planners, and policymakers can use this information to understand
future climate risks, prepare for extreme weather events, and plan adaptation strategies.
