...
including: - Number of heatwaves per year - Cooling and heating degree
days - Projected sea level rise
...
This code retrieves 10 rows of data from NYC Open Data endpoint for
...
across scenarios. It helps visualize future climate risks at glance.
