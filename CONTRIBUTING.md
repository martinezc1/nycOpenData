...
This guide explains how to report issues, suggest improvements, and contribute
...
By participating in this project, you agree to abide by the standards described
...
4. `sessionInfo()` output when relevant
