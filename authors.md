...
Source:
[`inst/CITATION`](https://github.com/martinezc1/nycOpenData/blob/main/inst/CITATION)

Martinez C (2026). *nycOpenData: A Lightweight Interface to NYC Open
Data APIs*. R package version 0.2.2,
<https://github.com/martinezc1/nycOpenData>.

    @Manual{,
      title = {nycOpenData: A Lightweight Interface to NYC Open Data APIs},
