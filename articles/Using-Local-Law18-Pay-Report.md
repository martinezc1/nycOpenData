...
By using the `nyc_pull_dataset` function, we can gather the most recent
statistics from Local Law 18 and filter based upon any of the columns
inside the dataset.
...
#>       <dbl> <chr>               <chr>              <chr>                   <dbl>
#> 1      2018 ADMINISTRATION FOR… ADMINISTRATIVE SU… 30000-3…                30000
#> 2      2018 ADMINISTRATION FOR… ADMINISTRATIVE SU… 30000-3…                30000
#> 3      2018 ADMINISTRATION FOR… ADMINISTRATIVE SU… 30000-3…                30000
...
employees. The `nyc_pull_dataset` function can filter based on any of
the columns in the dataset. To filter, we add `filters = list()` and put
whatever filters we would like inside. From our `names` call before, we
know that there is a column called “number_of_employees” which we can
...
Success! From calling the **423i-ukqr** from `nyc_pull_dataset` we see
...
#>   data_year agency_name         eeo_4_job_category pay_band lower_pay_band_bound
#>       <dbl> <chr>               <chr>              <chr>                   <dbl>
#> 1      2022 TECHNOLOGY & INNOV… ADMINISTRATIVE SU… 32.5-32…                 32.5
...
#> 6      2022 TECHNOLOGY & INNOV… ADMINISTRATIVE SU… 35000-3…              35000  
#> # ℹ 6 more variables: upper_pay_band_bound <dbl>, employee_status <chr>,
#> #   race <chr>, ethnicity <chr>, gender <chr>, number_of_employees <chr>
