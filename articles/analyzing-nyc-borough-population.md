...
The `xywu-7bv9()` function provides access to historical census data and
population projections from 1950 to 2040, allowing one to analyze
demographic trends across Brooklyn, Bronx, Manhattan, Queens, and Staten
Island.
...
The `xywu-7bv9()` function provides easy access to demographic data for
New York City spanning from 1950-2040. This enables analysis of
long-term population trends, comparisons across boroughs, and
exploration of projected future changes.
