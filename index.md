...
which retrieves a live catalog of available datasets from NYC Open Data
(`5tqd-u88y`).
...
- [`nyc_list_datasets()`](https://martinezc1.github.io/nycOpenData/reference/nyc_list_datasets.md)
  — Retrieve a live catalog of available NYC Open Data datasets,
  including dataset titles, human-readable keys, Socrata UIDs, endpoint
  URLs, and metadata used throughout the package.
- [`nyc_pull_dataset()`](https://martinezc1.github.io/nycOpenData/reference/nyc_pull_dataset.md)
  — Download cataloged NYC Open Data datasets using either a
  human-readable key or dataset UID, with support for filtering,
  ordering, date ranges, automatic type coercion, and optional column
  name cleaning.
- [`nyc_any_dataset()`](https://martinezc1.github.io/nycOpenData/reference/nyc_any_dataset.md)
  — Pull data directly from arbitrary NYC Open Data Socrata JSON
  endpoints without requiring inclusion in the internal package catalog.
