...
Version **0.2.1** introduces a streamlined, catalog-driven interface for
NYC Open Data.

Instead of maintaining dozens of individual dataset wrappers, the
package now provides three core functions:

- [`nyc_list_datasets()`](https://martinezc1.github.io/nycOpenData/reference/nyc_list_datasets.md)
  — Browse available datasets from the live NYC Open Data catalog
...
- [`nyc_any_dataset()`](https://martinezc1.github.io/nycOpenData/reference/nyc_any_dataset.md)
  — Pull any NYC Open Data dataset directly via its Socrata JSON
  endpoint

The catalog currently includes 30+ curated NYC Open Data datasets,
...
provides a more scalable interface for working with NYC Open Data.
...
- **Ease of Use**: No need to hunt for 4x4 dataset IDs (e.g.,
  `erm2-nwe9`); use
  [`nyc_pull_dataset()`](https://martinezc1.github.io/nycOpenData/reference/nyc_pull_dataset.md)
  with a human-readable catalog key.
